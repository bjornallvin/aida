      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <header className="text-center mb-8">
          ...
          <p className="text-gray-600">
            Your intelligent apartment companion
          </p>
        </header>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-lg shadow-lg p-6">
            ...
            <div className="border-t pt-6">
              ...
              <TextInput
                ...
                disabled={voiceInterface.isProcessing || voiceInterface.connectionStatus !== 'connected'}
          ...
          <div className="bg-white rounded-lg shadow-lg p-6">
            ...
            <ConversationDisplay
              ...
              isLoading={voiceInterface.isConversationLoading || voiceInterface.isProcessing}
            />
          </div>
        </div>
        ...
        <footer className="mt-12 text-center text-gray-500 text-sm">
          <p>
            Aida Web Client - Voice-enabled AI assistant for your smart apartment
          </p>
          <div className="mt-2 flex items-center justify-center space-x-4">
            <span className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${
              ...
              {voiceInterface.connectionStatus === 'connected' ? '● Connected' : 
               voiceInterface.connectionStatus === 'connecting' ? '◐ Connecting' : 
               '○ Disconnected'}
            </span>
